...
| 5 | 🟡 Medium | Exposed Token | Base64 High Entropy String found in md5.wasm.json | Rotate and secure the Base64 High Entropy String |
...
| 9 | 🟡 Medium | Exposed Token | Secret Keyword found in crypto.server.ts | Rotate and secure the Secret Keyword |
