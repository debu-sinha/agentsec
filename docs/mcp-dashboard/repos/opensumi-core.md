...
| 6 | 🟡 Medium | Exposed Token | Base64 High Entropy String found in md5.wasm.json | Rotate and secure the Base64 High Entropy String |
...
| 14 | 🟡 Medium | Exposed Token | Base64 High Entropy String found in interface-navigation.contribution.ts | Rotate and secure the Base64 High Entropy String |
