...
| 2 | 🟡 Medium | Exposed Token | Base64 High Entropy String found in interface-navigation.contribution.ts | Rotate and secure the Base64 High Entropy String |
...
| 6 | 🟡 Medium | Exposed Token | Secret Keyword found in zh-CN.lang.ts | Rotate and secure the Secret Keyword |
...
| 9 | 🟡 Medium | Exposed Token | Secret Keyword found in en-US.lang.ts | Rotate and secure the Secret Keyword |
| 10 | 🟡 Medium | Exposed Token | Secret Keyword found in ai-native.ts | Rotate and secure the Secret Keyword |
| 11 | 🟡 Medium | Exposed Token | Secret Keyword found in ai-native.ts | Rotate and secure the Secret Keyword |
| 12 | 🟡 Medium | Exposed Token | Secret Keyword found in ai-native.ts | Rotate and secure the Secret Keyword |
| 13 | 🟡 Medium | Exposed Token | Secret Keyword found in crypto.server.ts | Rotate and secure the Secret Keyword |
| 14 | 🟡 Medium | Exposed Token | Base64 High Entropy String found in md5.wasm.json | Rotate and secure the Base64 High Entropy String |
