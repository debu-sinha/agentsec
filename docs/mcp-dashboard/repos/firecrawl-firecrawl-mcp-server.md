...
| 2 | 🟡 Medium | Exposed Token | Secret Keyword found in index.ts | Rotate and secure the Secret Keyword |
| 3 | 🟡 Medium | Exposed Token | Secret Keyword found in smithery.yaml | Rotate and secure the Secret Keyword |
