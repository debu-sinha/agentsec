...
| 12 | 🟢 Low | Exposed Token | JSON Web Token found in memory-stack-integration.md | Rotate and secure the JSON Web Token |
...
| 18 | 🟢 Low | Exposed Token | Secret Keyword found in output-secrets-scanner.sh | Rotate and secure the Secret Keyword |
| 19 | 🟢 Low | Exposed Token | Private Key found in output-secrets-scanner.sh | Rotate and secure the Private Key |
...
| 22 | 🟢 Low | Exposed Token | Secret Keyword found in security-auditor.md | Rotate and secure the Secret Keyword |
