...
| 2 | 🟢 Low | Exposed Token | JSON Web Token found in script_test.go | Rotate and secure the JSON Web Token |
...
| 6 | 🟢 Low | Exposed Token | JSON Web Token found in scripts_test.go | Rotate and secure the JSON Web Token |
| 7 | 🟢 Low | Exposed Token | Secret Keyword found in conn_test.go | Rotate and secure the Secret Keyword |
