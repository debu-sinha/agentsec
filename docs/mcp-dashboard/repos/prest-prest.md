...
| 3 | 🟢 Low | Exposed Token | JSON Web Token found in config_test.go | Rotate and secure the JSON Web Token |
...
| 6 | 🟢 Low | Exposed Token | Base64 High Entropy String found in config_test.go | Rotate and secure the Base64 High Entropy String |
