...
| 4 | 🟢 Low | Exposed Token | Basic Auth Credentials found in database_registry_test.go | Rotate and secure the Basic Auth Credentials |
| 5 | 🟢 Low | Exposed Token | JSON Web Token found in script_test.go | Rotate and secure the JSON Web Token |
| 6 | 🟢 Low | Exposed Token | Secret Keyword found in logsafe_test.go | Rotate and secure the Secret Keyword |
