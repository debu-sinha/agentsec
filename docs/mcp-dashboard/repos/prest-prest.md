...
| 3 | 🟢 Low | Exposed Token | Base64 High Entropy String found in config_test.go | Rotate and secure the Base64 High Entropy String |
| 4 | 🟢 Low | Exposed Token | JSON Web Token found in config_test.go | Rotate and secure the JSON Web Token |
| 5 | 🟢 Low | Exposed Token | JSON Web Token found in config_test.go | Rotate and secure the JSON Web Token |
| 6 | 🟢 Low | Exposed Token | Basic Auth Credentials found in database_registry_test.go | Rotate and secure the Basic Auth Credentials |
| 7 | 🟢 Low | Exposed Token | Secret Keyword found in logsafe_test.go | Rotate and secure the Secret Keyword |
