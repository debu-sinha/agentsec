...
| 2 | 🟢 Low | Exposed Token | Base64 High Entropy String found in extension-fixtures.ts | Rotate and secure the Base64 High Entropy String |
| 3 | 🟢 Low | Exposed Token | Private Key found in key.pem | Rotate and secure the Private Key |
