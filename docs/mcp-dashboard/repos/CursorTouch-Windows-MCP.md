...
|--:|:--------:|----------|-------|-------------|
| 1 | 🟡 Medium | Exposed Token | Secret Keyword found in enums.py | Rotate and secure the Secret Keyword |
| 2 | 🟡 Medium | Exposed Token | Secret Keyword found in analytics.py | Rotate and secure the Secret Keyword |
| 3 | 🔵 Info | Outdated Version | Could not determine agent version | Ensure agent is updated to latest version |
