...
| 2 | 🟡 Medium | Exposed Token | Secret Keyword found in token-check.yml | Rotate and secure the Secret Keyword |
...
| 5 | 🟡 Medium | Exposed Token | Secret Keyword found in token-baseline.yml | Rotate and secure the Secret Keyword |
