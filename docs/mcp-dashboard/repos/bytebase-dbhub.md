...
| 28 | 🟢 Low | Exposed Token | Generic Connection String found in dsn-obfuscate.test.ts | Rotate and secure the Generic Connection String |
| 29 | 🟢 Low | Exposed Token | Generic Connection String found in dsn-obfuscate.test.ts | Rotate and secure the Generic Connection String |
...
| 31 | 🟢 Low | Exposed Token | Generic Connection String found in safe-url.test.ts | Rotate and secure the Generic Connection String |
| 32 | 🟢 Low | Exposed Token | Generic Connection String found in safe-url.test.ts | Rotate and secure the Generic Connection String |
| 33 | 🟢 Low | Exposed Token | Generic Connection String found in safe-url.test.ts | Rotate and secure the Generic Connection String |
| 34 | 🟢 Low | Exposed Token | Generic Connection String found in manager.test.ts | Rotate and secure the Generic Connection String |
| 35 | 🟢 Low | Exposed Token | Generic Connection String found in dsn-parser.test.ts | Rotate and secure the Generic Connection String |
| 36 | 🟢 Low | Exposed Token | Generic Connection String found in dsn-parser.test.ts | Rotate and secure the Generic Connection String |
