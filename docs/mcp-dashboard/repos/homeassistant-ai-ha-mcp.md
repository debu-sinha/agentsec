...
| 2 | 🟠 High | Config Drift | Suspicious pattern in AGENTS.md: System prompt injection marker | Review AGENTS.md for unauthorized modifications |
...
| 9 | 🟠 High | Config Drift | Suspicious pattern in AGENTS.md: Code execution instruction | Review AGENTS.md for unauthorized modifications |
| 10 | 🟢 Low | Exposed Token | JSON Web Token found in test_constants.py | Rotate and secure the JSON Web Token |
