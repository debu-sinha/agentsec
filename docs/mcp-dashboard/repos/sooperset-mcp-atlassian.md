...
| 6 | 🟢 Low | Exposed Token | Basic Auth Credentials found in test_proxy.py | Rotate and secure the Basic Auth Credentials |
| 7 | 🟢 Low | Exposed Token | Base64 High Entropy String found in test_oauth_dcr_harness.py | Rotate and secure the Base64 High Entropy String |
| 8 | 🟢 Low | Exposed Token | Secret Keyword found in test_restrictions.py | Rotate and secure the Secret Keyword |
| 9 | 🟢 Low | Exposed Token | Secret Keyword found in test_dependencies.py | Rotate and secure the Secret Keyword |
...
| 13 | 🟢 Low | Exposed Token | Secret Keyword found in test_cross_service.py | Rotate and secure the Secret Keyword |
