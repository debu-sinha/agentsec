...
| 4 | 🟢 Low | Exposed Token | Secret Keyword found in test_restrictions.py | Rotate and secure the Secret Keyword |
| 5 | 🟢 Low | Exposed Token | Secret Keyword found in test_environment.py | Rotate and secure the Secret Keyword |
| 6 | 🟢 Low | Exposed Token | Secret Keyword found in test_cross_service.py | Rotate and secure the Secret Keyword |
