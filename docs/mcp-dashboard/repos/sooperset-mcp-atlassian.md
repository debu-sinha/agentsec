...
| 2 | 🟢 Low | Exposed Token | Base64 High Entropy String found in test_oauth_dcr_harness.py | Rotate and secure the Base64 High Entropy String |
...
| 6 | 🟢 Low | Exposed Token | Secret Keyword found in test_restrictions.py | Rotate and secure the Secret Keyword |
...
| 11 | 🟢 Low | Exposed Token | Secret Keyword found in test_dependencies.py | Rotate and secure the Secret Keyword |
