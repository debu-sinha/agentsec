...
| 9 | 🟢 Low | Exposed Token | GitHub Token found in token_test.go | Rotate and secure the GitHub Token |
| 10 | 🟢 Low | Exposed Token | GitHub Token found in token_test.go | Rotate and secure the GitHub Token |
