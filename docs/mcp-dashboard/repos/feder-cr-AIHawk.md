...
| 5 | 🟢 Low | Exposed Token | IBM Cloud IAM Key found in test_key_isolation.py | Rotate and secure the IBM Cloud IAM Key |
| 6 | 🟢 Low | Exposed Token | Basic Auth Credentials found in test_one_plan_for_one_session.py | Rotate and secure the Basic Auth Credentials |
...
| 8 | 🟢 Low | Exposed Token | Secret Keyword found in test_env_file.py | Rotate and secure the Secret Keyword |
| 9 | 🟢 Low | Exposed Token | Secret Keyword found in test_env_file.py | Rotate and secure the Secret Keyword |
