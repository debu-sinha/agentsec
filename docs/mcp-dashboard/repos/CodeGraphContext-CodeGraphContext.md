...
| 3 | 🟢 Low | Exposed Token | Secret Keyword found in troubleshooting.md | Rotate and secure the Secret Keyword |
| 4 | 🟢 Low | Exposed Token | Secret Keyword found in README.md | Rotate and secure the Secret Keyword |
| 5 | 🟢 Low | Exposed Token | Secret Keyword found in DOCKER_DEPLOYMENT.md | Rotate and secure the Secret Keyword |
| 6 | 🟢 Low | Exposed Token | Secret Keyword found in README.kor.md | Rotate and secure the Secret Keyword |
