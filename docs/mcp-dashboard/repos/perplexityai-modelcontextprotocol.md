...
| 2 | 🟡 Medium | Exposed Token | Secret Keyword found in test.yml | Rotate and secure the Secret Keyword |
| 3 | 🟢 Low | Exposed Token | Secret Keyword found in transport.test.ts | Rotate and secure the Secret Keyword |
| 4 | 🟡 Medium | Exposed Token | Secret Keyword found in vitest.config.ts | Rotate and secure the Secret Keyword |
