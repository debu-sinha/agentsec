...
| 7 | 🔴 Critical | Malicious Skill | Remote pipe to shell in skill 'ai-tools-setup' | Remove skill 'ai-tools-setup' and investigate |
| 8 | 🔴 Critical | Malicious Skill | PowerShell remote execution in skill 'ai-tools-setup' | Remove skill 'ai-tools-setup' and investigate |
