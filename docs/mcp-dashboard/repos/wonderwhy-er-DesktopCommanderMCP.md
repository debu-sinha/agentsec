...
| 3 | 🟠 High | Malicious Skill | Credential path targeting in skill 'ai-tools-setup' | Remove skill 'ai-tools-setup' and investigate |
| 4 | 🟠 High | Malicious Skill | Credential path targeting in skill 'ai-tools-setup' | Remove skill 'ai-tools-setup' and investigate |
