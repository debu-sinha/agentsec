...
| 7 | 🟡 Medium | Exposed Token | Secret Keyword found in gemini.go | Rotate and secure the Secret Keyword |
| 8 | 🟢 Low | Exposed Token | Secret Keyword found in mindsdb_integration_test.go | Rotate and secure the Secret Keyword |
| 9 | 🟢 Low | Exposed Token | Secret Keyword found in looker_mcp.md | Rotate and secure the Secret Keyword |
| 10 | 🟢 Low | Exposed Token | Secret Keyword found in index.md | Rotate and secure the Secret Keyword |
...
| 18 | 🟢 Low | Exposed Token | Secret Keyword found in cloud_sql_mysql_create_instance_integration_test.go | Rotate and secure the Secret Keyword |
