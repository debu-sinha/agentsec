...
| 6 | 🟢 Low | Exposed Token | Secret Keyword found in LOOKER_README.md | Rotate and secure the Secret Keyword |
...
| 15 | 🟢 Low | Exposed Token | Secret Keyword found in prompts_quickstart_gemini_cli.md | Rotate and secure the Secret Keyword |
| 16 | 🟢 Low | Exposed Token | Secret Keyword found in index.md | Rotate and secure the Secret Keyword |
...
| 21 | 🟢 Low | Exposed Token | Secret Keyword found in mindsdb_integration_test.go | Rotate and secure the Secret Keyword |
| 22 | 🟢 Low | Exposed Token | Secret Keyword found in test-snowflake.sh | Rotate and secure the Secret Keyword |
