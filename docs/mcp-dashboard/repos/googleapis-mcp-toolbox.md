...
| 5 | 🟢 Low | Exposed Token | Secret Keyword found in cloud_sql_pg_create_instances_test.go | Rotate and secure the Secret Keyword |
...
| 8 | 🟢 Low | Exposed Token | Secret Keyword found in colab_quickstart.ipynb | Rotate and secure the Secret Keyword |
...
| 13 | 🟢 Low | Exposed Token | Secret Keyword found in mindsdb_integration_test.go | Rotate and secure the Secret Keyword |
...
| 20 | 🟢 Low | Exposed Token | Secret Keyword found in _index.md | Rotate and secure the Secret Keyword |
