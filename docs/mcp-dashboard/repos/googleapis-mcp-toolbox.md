...
| 8 | 🟢 Low | Exposed Token | Secret Keyword found in test-snowflake.sh | Rotate and secure the Secret Keyword |
...
| 12 | 🟢 Low | Exposed Token | Secret Keyword found in cloud_sql_mysql_create_instance_mcp_integration_test.go | Rotate and secure the Secret Keyword |
