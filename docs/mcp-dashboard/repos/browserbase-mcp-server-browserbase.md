...
| 3 | 🟡 Medium | Exposed Token | Secret Keyword found in run-evals.ts | Rotate and secure the Secret Keyword |
| 4 | 🟡 Medium | Exposed Token | Secret Keyword found in config.ts | Rotate and secure the Secret Keyword |
| 5 | 🟡 Medium | Exposed Token | Secret Keyword found in config.ts | Rotate and secure the Secret Keyword |
