...
**Repository:** [agentset-ai/agentset](https://github.com/agentset-ai/agentset)
**Stars:** 1,861
...
|--:|:--------:|----------|-------|-------------|
| 1 | 🟡 Medium | Exposed Token | Secret Keyword found in internal-api.ts | Rotate and secure the Secret Keyword |
